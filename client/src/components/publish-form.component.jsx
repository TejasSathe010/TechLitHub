...
const PublishForm = () => {
  ...
  const publishBlog = (e) => {
    ...
    if (!des.length || des.length > characterLimit) {
      return toast.error(`Write a blog description within ${characterLimit} characters to publish`);
    }
    ...
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <div className="border-grey lg:border-1 lg:pl-8">
          ...
          <p className="text-dark-grey mb-2 mt-9">Topics: ( Helps in searching and ranking your blog posts )</p>
